...
import { CreateUserRequest, GetUserDetailsRequest, GetUserDetailsResponse, IDENTITY_SERVICE_NAME, LoginResponse, RegisterResponse, UpdateUserRequest, ValidateResponse } from '../proto/identity.pb';
